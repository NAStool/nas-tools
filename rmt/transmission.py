...
class Transmission:
    ...
    def __init__(self):
        ...
        if config.get('transmission'):
            __trhost = config['transmission'].get('trhost')
            __trport = config['transmission'].get('trport')
            __trusername = config['transmission'].get('trusername')
            __trpassword = config['transmission'].get('trpassword')
            __save_path = config['transmission'].get('save_path')
            __save_containerpath = config['transmission'].get('save_containerpath')
            self.media = Media()
            if __trhost and __trport:
