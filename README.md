...
【声明】1、本项目1年前就开始建库，媒体识别改名等核心功能一开始就有，代码写的比较烂但主体功能目前没有使用甚至参考任何人的代码（GIT有所有代码改动记录）。2、本项目最早期由个人自用需求发展而来，近段时间咨询的人多才建讨论群和根据大家的需求改动代码，完全基于个人兴趣爱好，不求回报，无任何商业目的，将来也不会有。3、如果影响到了一些人或者团体的商业利益，那也不是我主观意愿。如涉及侵权请直接告知（没想到会有什么地方涉及侵权）。
