...
[![Docker pulls](https://img.shields.io/docker/pulls/nastool/nas-tools?style=plastic)](https://hub.docker.com/r/nastool/nas-tools)
...
## 免责声明
1) 本软件仅供学习交流使用，软件本身仅作为辅助工具简化用户手工操作，对用户的行为及内容毫不知情，使用本软件产生的任何责任需由使用者本人承担。
