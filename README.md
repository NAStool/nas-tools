...
## 功能：
### 1、PT搜刮下载
a) 根据配置的关键字，从PT站定时搜刮种子，自动添加qBittorrent任务下载。比如电影可配置2022关键字，把2022年新出的资源都自动下载

b) qBittorrent下载完成后自动识别电影剧集名称并重命名为Emby/Plex格式，自动复制到Emby/Plex媒体库目录下并自动分好类，重命名后可实现100%完美识别

c) qBittorrent定期删种，避免下载盘被挤爆
