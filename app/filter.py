...
from app.utils import StringUtils, SystemConf
...
class Filter:
    ...
    def check_torrent_filter(self,
        ...
        if filter_args.get("restype"):
            restype_re = SystemConf.TORRENT_SEARCH_PARAMS["restype"].get(filter_args.get("restype"))
        ...
        if filter_args.get("pix"):
            pix_re = SystemConf.TORRENT_SEARCH_PARAMS["pix"].get(filter_args.get("pix"))
