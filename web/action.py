...
class WebAction:
    ...
    def __add_brushtask(data):
        ...
        # 存储消息开关
        DictHelper.set(SystemDictType.BrushMessageSwitch.value, "brushtask_".brushtask_id, brushtask_sendmessage)
    ...
    def __brushtask_detail(data):
        ...
        sendmessage_switch = DictHelper.get(SystemDictType.BrushMessageSwitch.value, "brushtask_".brushtask[0][0])
        task = {
            "id": brushtask[0][0],
            "name": brushtask[0][1],
            "site": brushtask[0][2],
