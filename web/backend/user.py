...
class User(UserMixin):
    ...
    def get_services(self):
        ...
        '''
        SchedulerTasks['rssdownload'] = {'name': 'RSS订阅', 'time': None, 'state': None, 'id': 'rssdownload', 'svg': svg,
                                         'color': "blue"}
        ...
        SchedulerTasks['subscribe_search_all'] =  {'name': '订阅搜索', 'time': None, 'state': None, 'id': 'subscribe_search_all',
             'svg': svg,
             'color': "blue"}
         # 下载文件转移
        svg = '''
        ...
        '''
        SchedulerTasks['pttransfer'] = {'name': '下载文件转移', 'time': None, 'state': None, 'id': 'pttransfer', 'svg': svg,
             'color': "green"}
        # 删种
        svg = '''
        ...
        '''
        SchedulerTasks['blacklist'] = {'name': '清理转移缓存', 'time': '手动', 'state': 'OFF', 'id': 'blacklist', 'svg': svg, 'color': 'red'}
        ...
        svg = '''
            ...
            '''
        SchedulerTasks['rsshistory'] = {'name': '清理RSS缓存', 'time': '手动', 'state': 'OFF', 'id': 'rsshistory', 'svg': svg, 'color': 'purple'}
        ...
        '''
        SchedulerTasks['nametest'] = {'name': '名称识别测试', 'time': '', 'state': 'OFF', 'id': 'nametest', 'svg': svg, 'color': 'lime'}
        ...
        '''
        SchedulerTasks['ruletest'] =  {'name': '过滤规则测试', 'time': '', 'state': 'OFF', 'id': 'ruletest', 'svg': svg, 'color': 'yellow'}
        ...
        '''
        SchedulerTasks['backup'] = {'name': '备份&恢复', 'time': '', 'state': 'OFF', 'id': 'backup', 'svg': svg, 'color': 'green'}
        ...
        SchedulerTasks['nettest'] =  {'name': '网络连通性测试', 'time': '', 'state': 'OFF', 'id': 'nettest', 'svg': svg, 'color': 'cyan',
            "targets": targets}
